...
COPY contract_filler.py web_app.py chat_ui.html esign.py pension_store.py dashboard.html login.html pension.html ./
COPY gmail_client.py invoice_store.py invoice_ingest.py inventory.html branches.py ./
